...
transect_traj = [[0.4, 0]] .+ [[0.2, 0.5], [0.25, 1], [0, 1], [-0.1, 1.4],
    [0.27, 1.4], [0.28, 1.75], [-0.08, 1.75], [-0.05, 2.15], [0.35, 2.15],
    [0.4, 2.55], [-0.02, 2.55], [0, 3], [0.45, 3], [0.48, 3.4],
    [0.05, 3.4], [0.1, 3.8], [0.5, 3.8], [0.55, 4.2], [0.15, 4.2],
    [0.2, 4.55], [0.6, 4.55], [0.65, 4.95], [0.3, 4.95], [0.5, 5.3],
    [0.7, 5.3], [0.75, 5.75]] # one-way transect trajectory assumed to be
#                           followed back and forth
